...
class WorksheetRenderer {
    ...
    render(data) {
        ...
        footer.className = 'worksheet-footer-sim';
        footer.innerHTML = `
            <div>📝 MathWizard Pro</div>
            <div>Generated by kids-math.io</div>
        `;
        wsPage.appendChild(footer);
    ...
    _renderAnswerKey(data, numCols) {
        ...
        // Footer for Answer Key too
        const footer = document.createElement('div');
        footer.className = 'worksheet-footer-sim';
        footer.innerHTML = `
            <div>📝 MathWizard Pro</div>
            <div>Answer Key Reference</div>
        `;
